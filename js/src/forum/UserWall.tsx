  ...
  loadDiscussion(discussions_wall: string) {
    ...
    app.store
      ...
      .then((discussion: ApiResponseSingle<Model>) => {
        ...
        this.selectedDiscussion = discussion as unknown as Discussion;
        this.stream = new PostStreamState(this.selectedDiscussion, includedPosts); //null //discussions.postStream();
